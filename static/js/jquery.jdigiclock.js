...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                clockImagesPath: 'http://127.0.0.1:8001/static/img/jdigiclock/clock/',
                weatherImagesPath: 'http://127.0.0.1:8001/static/img/jdigiclock/weather/',
                lang: 'en',
                am_pm: false,
                weatherLocationCode: 'EUR|HR|HR004|ZAGREB',
                weatherMetric: 'C',
                weatherUpdate: 0,
                proxyType: 'php'
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="http://127.0.0.1:8001/static/img/jdigiclock/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="http://127.0.0.1:8001/static/img/jdigiclock/icon_right.png" /></p>';
